        ...
        <ul className="list-decimal">
          ...
          <li>
            ...
            <li>
              ...
              <div><span className="text-designColor font-medium">Lu Sun</span>, Lillio Mok, Shilad Sen, Bahar Sarrafzadeh</div>
            ...
            <li>
              ...
              <div><span className="text-designColor font-medium">Lu Sun</span>, Chia-Jung Lee, Vanessa Murdock, Barbara Poblete and Max Harper</div>
            ...
            <li>
              ...
              <div>Lillio Mok, <span className="text-designColor font-medium">Lu Sun</span>, Shilad Sen, Bahareh Sarrafzadeh</div>
            ...
            <li>
              ...
              <div>Enze Liu, <span className="text-designColor font-medium">Lu Sun</span>, Alex Bellon, Grant Ho, Geoffrey M. Voelker, Stefan Savage, Imani N. S. Munyaka</div>
            ...
            <li>
              ...
              <div><span className="text-designColor font-medium">Lu Sun</span>, Yuhan Liu, Grace Joseph, Zhou Yu, Haiyi Zhu, Steven P. Dow</div>
            ...
            <li>
              ...
              <div>Brian McInnis, Leah Ajmani, <span className="text-designColor font-medium">Lu Sun</span>, Krystal Zeng, Yvonne Hou, Steven P. Dow</div>
            ...
            <li>
              ...
              <div>Brian McInnis, <span className="text-designColor font-medium">Lu Sun</span>, Jungwon Shin, Steven P. Dow</div>
            ...
            <li>
              ...
              <div><span className="text-designColor font-medium">Lu Sun</span>, Robert E. Kraut, Diyi Yang</div>
              <div><span className="font-medium">CSCW'20</span>: In Proceedings of The 23rd ACM Conference on Computer-Supported Cooperative Work and Social Computing</div>
              <span className="text-lg inline-flex justify-center items-center text-darkColor hover:text-designColor duration-300 cursor-pointer">
            ...
            <li>
              ...
              <div>Kenneth Koedinger, <span className="text-designColor font-medium">Lu Sun</span>, Elizabeth A. McLaughlin</div>
            ...
            <li>
              ...
              <div>Yuntao Wang, Ke Sun, <span className="text-designColor font-medium">Lu Sun</span>, Chun Yu, and Yuanchun Shi</div>
